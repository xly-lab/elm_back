<template>
	<div>
		<div class="food_list">
			...
			>
				<van-collapse v-model="activeNames" accordion v-for="(item,key) in list" :key="key">
					<van-collapse-item :name="key" title="食品名称" icon="thumb-circle-o">
						<div slot="title" class="title_header" @click="setFoodInfo(item)">
							{{item.food_name}}
						...
						<div class="shop_info">
							...
							<div class="shop_info_handle">
								...
								<van-button
									v-show="userinfo?userinfo.user_type==2:userInfo.user_type==2"
									type="danger"
									plain
									hairline
									size="small"
				...
				<van-overlay :show="show" @click="show = false">
					<div class="wrapper" @click="show=false">
						<div class="block" @click.stop>
							...
							<van-cell-group>
								<van-field v-model="food_name" clearable disabled label="商品名称" placeholder="请输入商品名称" />
								<van-field v-model="food_active" label="商品活动" placeholder="请输入商品活动" required />
								<van-field v-model="food_detail" label="商品详情" placeholder="请输入商品详情" required />
								<van-field
								...
								/>
								<van-field v-model="food_price" required clearable label="商品价格" placeholder="请输入商品价格" />
...
export default {
	...
	methods: {
		...
		changeFood() {
			...
			if (
				!(
					this.food_characteristics === "招牌" ||
					this.food_characteristics === "新品"
				)
			) {
