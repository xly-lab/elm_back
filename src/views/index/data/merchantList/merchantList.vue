		...
		<div class="merchant-list">
			...
			>
				<van-collapse v-model="activeNames" accordion v-for="(item,key) in list" :key="key">
					<van-collapse-item :name="key" title="店铺名称" icon="shop-o">
						<div slot="title" class="title_header" @click="setShopInfo(item)">
							{{item.shop_name}}
				...
				<van-overlay :show="show" @click="show = false">
					<div class="wrapper" @click="show=false">
						<div class="block" @click.stop>
							...
							<van-cell-group>
								<van-field v-model="shop_name" clearable disabled label="店铺名称" placeholder="请输入店铺名称" />
								<van-field v-model="shop_address" label="详细地址" placeholder="请输入详细地址" required />
								<van-field v-model="shop_detail" required clearable label="店铺介绍" placeholder="请输入店铺介绍" />
								<van-field v-model="shop_phone" required clearable label="联系电话" placeholder="请输入联系电话" />
